...
const currentRaffle = {
  ...
  prizes: [
    {
      place: "1st",
      description: "Limited Edition HOLLOWVOX Hoodie + NFT Collection",
      value: "$150",
    },
    {
      place: "2nd",
      description: "HOLLOWVOX Digital Art Pack + Stickers",
      value: "$75",
    },
...
export default function RafflePage() {
  ...
  const daysLeft = Math.ceil(
    (new Date(currentRaffle.endDate).getTime() - Date.now()) /
      (1000 * 60 * 60 * 24)
  );
    ...
    <div className="py-12 md:py-16">
      <div className="text-center mb-12">
        <h1 className="font-orbitron text-4xl font-bold md:text-5xl mb-4">
          Hollower Monthly Raffle
        </h1>
        <p className="mx-auto max-w-3xl text-muted-foreground">
          Enter our monthly raffle to win exclusive HOLLOWVOX merchandise, NFTs,
          and digital art. No purchase required - just hold HOLLOWVOX tokens or
          enter for free!
        </p>
      </div>
      ...
      <Alert className="mb-8 border-primary/50 bg-primary/10 max-w-4xl mx-auto">
        ...
        <AlertDescription className="text-primary-foreground/90">
          <strong>No Purchase Necessary:</strong> This raffle is free to enter.
          You can participate by holding HOLLOWVOX tokens OR by entering with
          your email address. Holding tokens is not required to win.
        </AlertDescription>
      </Alert>
          ...
          <CardHeader>
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="text-center">
                <Badge
                  variant="outline"
                  className="border-primary text-primary text-lg px-4 py-2"
                >
            ...
            <div className="text-center">
              <p className="text-muted-foreground">
                ...
                <span className="font-bold text-foreground">
                  {currentRaffle.totalEntries.toLocaleString()}
                </span>
              </p>
            </div>
          </CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-card/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                Connect your wallet to automatically enter based on your
                HOLLOWVOX token balance
              </CardDescription>
            </CardHeader>
              ...
              {isConnected ? (
                  ...
                  <div className="p-4 bg-muted/20 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="font-bold">
                        {balance?.toLocaleString() || 0} HOLLOWVOX
                      </span>
                    </div>
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-muted-foreground">
                    ...
                    <div className="text-xs text-muted-foreground">
                      1 entry per 1,000,000 HOLLOWVOX tokens held
                    </div>
                  </div>
                  ...
                  {walletEntries > 0 ? (
                    ...
                    <Alert className="border-amber-500/50 bg-amber-500/10">
                      <AlertDescription className="text-amber-200">
                        You need at least 1,000,000 HOLLOWVOX tokens to get
                        wallet-based entries. You can still enter for free using
                        the email option!
                      </AlertDescription>
                    </Alert>
                  )}
                ...
                <div className="text-center py-8">
                  <p className="text-muted-foreground mb-4">
                    Connect your wallet to enter based on your holdings
                  </p>
          ...
          <Card className="bg-card/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>
                Enter the raffle for free using your email address
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-green-500/10 border-green-500/50">
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <h3 className="font-orbitron text-xl font-bold text-green-400 mb-2">
                ...
                <p className="text-green-200">
                  {entryStatus === "both"
                    ? `You're entered with ${
                        walletEntries + 1
                      } total entries (${walletEntries} from wallet + 1 free entry)`
                    : entryStatus === "wallet"
                ...
                <p className="text-sm text-green-300 mt-2">
                  ...
                  {new Date(currentRaffle.endDate).toLocaleDateString()}
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="bg-card/50 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="font-orbitron text-xl">
              Raffle Rules & Legal Information
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 text-sm text-muted-foreground">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>
                  <strong>Wallet Entry:</strong> Connect your wallet to get 1
                  entry per 1,000,000 HOLLOWVOX tokens held
                </li>
                <li>
                  <strong>Free Entry:</strong> Enter with your email address for
                  1 free entry (no purchase required)
                </li>
